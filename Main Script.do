...
xtreg crime wage gdp pop edu unmply gini pov law imig, fe
...
xsmle crime wage gdp pop edu unmply gini pov law imig, wmat (W1) model (sar) fe type (ind) effects
estat ic
eststo model2
esttab, r2 aic 
...
* SAR Random Effect
xsmle crime wage gdp pop edu unmply gini pov law imig, wmat (W1) model (sar) re 
estat ic
eststo model3
esttab, r2 aic 
...
xsmle crime wage gdp pop edu unmply gini pov law imig, emat (W1) model (sem) fe type (ind) effects
estat ic
eststo model4
esttab, r2 aic 
...
xsmle crime wage gdp pop edu unmply gini pov law imig, emat (W1) model (sem) re
estat ic
eststo model5
esttab, r2 aic 
...
xsmle crime wage gdp pop edu unmply gini pov law imig, wmat (W1) model (sdm) fe type (ind) effects
estat ic
eststo model6
esttab, r2 aic 
...
xsmle crime wage gdp pop edu unmply gini pov law imig, wmat (W1) model (sdm) re
estat ic
eststo model7
esttab, r2 aic 
